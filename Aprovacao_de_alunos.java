...
public class Aprovacao_de_alunos
{
	public static void main(String[] args) {
	    ...
	    for(int j=0; j<numAlunos; j++){
	        System.out.println("\nAluno: "+alunos_resultado[j][0]+", Nota 1: "+Array_notas[j][0]+", Nota 2: "+Array_notas[j][1]+", Média: "+Array_notas[j][2]+", Situação: "+alunos_resultado[j][1]);
